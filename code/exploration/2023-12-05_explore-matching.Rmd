...
It seems like optimal pair matching would be best (`method = "optimal"`), 
but if it's too slow we could go for generalised full matching (`method = "quick"`). 
...
but I guess the treatment groups were already quite well matched.
...
When we model the data, we're supposed to include the matching weights in the estimation.
