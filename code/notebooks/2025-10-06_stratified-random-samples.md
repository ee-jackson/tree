...
Basically, we take all the possible test data (all NFI plots):, and
...
Now add training data to keys. Runs with the same sample size will have
...
![](figures/2025-10-06_stratified-random-samples/unnamed-chunk-15-1.png)<!-- -->
