...
In our study we have imposed unbalanced treatment assignment and would expect the propensity scores to reflect this.
...
We need the propensity scores for the train data, 
so will have to either build this into the `fit_metalearner()` function, 
or output the train data.
...
We've decided to drop the `blocked_random` category. 
